(function () {'use strict';
    ...
    angular.module('angular-echarts.util', []).factory('util', function () {
        ...
        function getAxisTicks(data, config, type) {
            ...
            return {
                type: typeof(config.xAxis)==='undefined'?'category':config.xAxis.type,
        ...
        function getSeries(data, config, type) {
            ...
            angular.forEach(data, function (serie) {
                ...
                if (!isAxisChart(type)||config.xAxis.type==='time') {
                    //if (!isAxisChart(type)||(config.xAxis.hasOwnProperty('type')&&config.xAxis.type==='time')) {
                    conf.data = [];
                    angular.forEach(serie.datapoints, function (datapoint) {
                        conf.data.push({
                            value: datapoint.y,
                ...
                if (isPieChart(type)) {
                    ...
                    conf.avoidLabelOverlap=config.avoidLabelOverlap;
                    ...
                    if (type === 'donut') {
                        ...
                        conf = angular.extend(conf, {
                            itemStyle: {
                                ...
                                normal: {
                                    label: {
                                        show:config.label.normal.show,
                                        position: config.label.normal.position,
